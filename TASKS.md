...
* [ ] （未確認）US100・US500・US2000の全期間のスプレッド分布の確認（DEC-034「追加確認」に相当。実施していない）
...
* **限界**: (1) 米国株指数3資産はUS30と同じ米国株指数で、独立した観測とは言えない。(2) ケースごとのトレード数は14〜67件と少なく、有意性の検定は行っていない。(3) 資産の価格トレンド（JP225・US100・US500の2025-2026年の上昇、XAUUSDの上昇）との交絡を分離していない。(4) 拒否（`SPREAD_TOO_WIDE`・`SIZE_BELOW_MIN`）による候補の選別が、特に2025-2026年（`SPREAD_TOO_WIDE` 11.9%、`SIZE_BELOW_MIN` 10.2%）で結果を歪めうる。(5) 未確認: FX同士でも円・ユーロを含まない通貨ペア（tick未投入のため未実施）、より長期のヒストリー、米国株指数以外の非FX資産。
