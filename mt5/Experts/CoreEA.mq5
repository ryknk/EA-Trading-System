...
input double          InpPullbackTriggerAtrBuffer=0.10;
...
input bool            InpEntryUseStagedPipeline=true;
input bool            InpEntryRequireMarketRegimeTrend=true;
input double          InpRegimeTrendAdxMin=40.0;
...
input bool            InpEnableAdaptiveSizing=false;
input int             InpAdaptiveSizingLookbackTrades=10;
input double          InpAdaptiveSizingSensitivity=1.0;
input double          InpAdaptiveSizingFloorMultiplier=0.5;
input EStrategyMode   InpStrategyMode=STRATEGY_MODE_TREND_ONLY;
input int             InpMeanReversionBbPeriod=20;
input double          InpMeanReversionBbDeviation=2.0;
input int             InpMeanReversionChoppinessPeriod=14;
input double          InpMeanReversionChoppinessMin=60.0;
input double          InpMeanReversionAdxMax=25.0;
input double          InpMeanReversionStopAtrMultiple=1.0;
input int             InpMeanReversionMaxReentryBars=3;
...
input int             InpMeanReversionRangeBreakLookback=20;
input double          InpMeanReversionBreakAtrMultiplier=0.25;
input int             InpMeanReversionBreakConfirmSeconds=5;
input bool            InpMeanReversionRestrictToTokyoSession=false;
input int             InpMeanReversionMaxHoldingBars=10;
...
input bool            InpEnableAtrTrailingStop=false;
input double          InpAtrTrailingTriggerR=1.0;
input double          InpAtrTrailingAtrMultiple=2.0;
...
input bool            InpEnableTrendReversalExit=false;
input double          InpTrendReversalActivationR=1.0;
input double          InpTrendReversalRetraceR=0.5;
input int             InpTrendReversalConfirmationTicks=5;
input bool            InpEnableEarlyAdverseExit=true;
input double          InpEarlyAdverseExitTriggerR=0.75;
input int             InpEarlyAdverseExitConfirmationTicks=5;
...
int OnInit(void)
  {
   ...
   config.enable_adaptive_sizing=InpEnableAdaptiveSizing;
   config.adaptive_sizing_lookback_trades=InpAdaptiveSizingLookbackTrades;
   config.adaptive_sizing_sensitivity=InpAdaptiveSizingSensitivity;
   config.adaptive_sizing_floor_multiplier=InpAdaptiveSizingFloorMultiplier;
   config.strategy_mode=(int)InpStrategyMode;
   config.enable_mean_reversion_strategy=CStrategyModeRules::IsMeanReversionModeActive(config.strategy_mode);
   config.mean_reversion_bb_period=InpMeanReversionBbPeriod;
   config.mean_reversion_bb_deviation=InpMeanReversionBbDeviation;
   config.mean_reversion_choppiness_period=InpMeanReversionChoppinessPeriod;
   config.mean_reversion_choppiness_min=InpMeanReversionChoppinessMin;
   config.mean_reversion_adx_max=InpMeanReversionAdxMax;
   config.mean_reversion_stop_atr_multiple=InpMeanReversionStopAtrMultiple;
   config.mean_reversion_max_reentry_bars=InpMeanReversionMaxReentryBars;
   ...
   config.mean_reversion_range_break_lookback=InpMeanReversionRangeBreakLookback;
   config.mean_reversion_break_atr_multiplier=InpMeanReversionBreakAtrMultiplier;
   config.mean_reversion_break_confirm_seconds=InpMeanReversionBreakConfirmSeconds;
   config.mean_reversion_restrict_to_tokyo_session=InpMeanReversionRestrictToTokyoSession;
   ...
   config.enable_atr_trailing_stop=InpEnableAtrTrailingStop;
   config.atr_trailing_trigger_r_multiple=InpAtrTrailingTriggerR;
   config.atr_trailing_atr_multiple=InpAtrTrailingAtrMultiple;
   ...
   config.enable_trend_reversal_exit=InpEnableTrendReversalExit;
   config.trend_reversal_activation_r_multiple=InpTrendReversalActivationR;
   config.trend_reversal_retrace_r_multiple=InpTrendReversalRetraceR;
   config.trend_reversal_confirmation_ticks=InpTrendReversalConfirmationTicks;
   config.enable_early_adverse_exit=InpEnableEarlyAdverseExit;
   config.early_adverse_exit_trigger_r_multiple=InpEarlyAdverseExitTriggerR;
   config.early_adverse_exit_confirmation_ticks=InpEarlyAdverseExitConfirmationTicks;
