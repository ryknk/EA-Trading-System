...
$tests = @("TestTrendFollowingRules", "TestMarketRegimeClassifier", "TestPositionSizer", "TestRiskGuards", "TestTradingRules", "TestDecisionApiRules", "TestAuditRules", "TestAuditPayloadBuilder", "TestProductionSafetyRules", "TestEntryTimingAnalyzer")
